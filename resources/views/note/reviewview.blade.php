                      ...
                      <table id="table" class="table table-bordered table-hover">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td><a href="{{url('note/note-detail-r-view').'/'.$value->id.'/'.'review'}}">{{$value->no}}</a></td>
            ...
            buttons: [
                {
                    ...
                    action: function(dialogItself){
                        var url = "{{url('note/review-view/next')}}";
            ...
            buttons: [
                {
                    ...
                    cssClass: 'btn-danger',
                    action: function(dialogItself){
                        var url = "{{url('note/review-view/reject')}}";
                        $('#nextform').attr('action',url);
                        $('#nextform').submit();
                    }
                }, 
