...
<section class="content-header">
    ...
    <ol class="breadcrumb">
     <li><a href="{{url('')}}"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <li class="active"><a onclick="window.history.go(-1); return false;">打寶積分一覽</a></li>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary"  onclick="window.history.go(-1); return false;">返回</a>
        </div>
...
@endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>分得鑽石(實收*0.8/{{count($moneylog->treasure->details)}})</label>
